    	...
    	<form class = "mix-page-content" action = "/operation/jsfreeOrder" method = "post">
		    ...
		    <div class = "mix-content">
		        <div class = "mix-address">
		            ...
		            <p style = "font-size: 14px;">Output address #10</p>
		            <input class = "input-address" type="text" maxlength = "74" autocomplete="off" placeholder = "your Bitcoin address #10" required name = "address9">
		            <p style = "font-size: 14px;">Delay #10:&nbsp;</p>
		            <input class = "input-bitcode" type="text" maxlength = "2" autocomplete="off" placeholder = "from 0 to 48 hours" required name = "delay9">
		            <p style = "font-size: 14px;">Share #10:&nbsp;</p>
		            <input class = "input-bitcode" type="text" maxlength = "2" autocomplete="off" placeholder = "from 1 to 99 %" required name = "delay9">

		            <input style = "display: none" type="text" required name = "outputsNumber" value = "10">
		        </div>
		    </div>
